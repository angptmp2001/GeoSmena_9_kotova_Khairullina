        ...
        container.innerHTML = `
            <div class="screen active" id="screen-home">
                <div class="home-greeting">
                    <h1>Привет,Юный геолог ${profile.name}!</h1>
                    <p> 🌍Мы уверенны, что ты готов к октрытиям</p>
                </div>

                <div class="home-stats-row">
                    <div class="home-stat-card">
                        <div class="stat-number">${mineralCount}</div>
                        <div class="stat-label">💥Полезные ископаемые</div>
                    </div>
                    <div class="home-stat-card">
                    ...
                    <div class="home-stat-card">
                        ...
                        <div class="stat-label">Экспедиций</div>
                    </div>
                </div>
